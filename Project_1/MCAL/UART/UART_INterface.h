...
/**
 * @brief  Non-blocking function to receive a single byte via UART.
 * @param pu8Data Pointer to a variable where the received byte will be stored.
 * @return u8 Status of the reception process:
 */
u8 UART_u8ReceiveNoBlock(u8 *pu8Data);
